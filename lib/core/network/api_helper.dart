...
// import 'package:login_task_nti/core/network/api_response.dart';
...
//             headers:
//             {
//               if(isProtected) 'Authorization': 'Bearer ${sendRefreshToken? CacheHelper.getData(key: CacheKey.refreshToken): CacheData.accessToken}',
//             }
//         )
//     ));
//   }

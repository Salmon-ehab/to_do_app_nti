...
import 'package:login_task_nti/feature/edit_task/presentation/views/edit_task_view.dart';
...
class TaskWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: (){
        MyNavigator.goTo(screen: ()=> EditTaskView(taskModelHome: taskModelHome));
      },
      child: Container(
        height: 90.h,
        width: 335.w,

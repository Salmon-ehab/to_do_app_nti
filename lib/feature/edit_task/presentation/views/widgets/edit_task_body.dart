...
import 'package:login_task_nti/feature/edit_task/presentation/views/widgets/custom_appbar.dart';
                ...
                children: [
                  ...
                  UpdateButton(onPressed: () {
                    EditTaskCubit.get(context)
                        .editTask(taskId: taskModelHome.id!);
                  })
                ],
              ),
            ),
